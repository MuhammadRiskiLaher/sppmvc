...
<br>
<br>
<h3 style="margin-left: 25px;">Tabel Petugas</h3>
<h3 style="margin-left: 25px;"><a href=" view_post_petugas.php" class="text-dark"> TAMBAH DATA</a></h3>
	...
	?>
			<tr>
				...
				<td>
					...
					<button style="background: none;"><a href=" ../views/view_put_petugas.php?id_petugas=<?php echo base64_encode($Get['id_pembayaran']) ?>"> <img src="../img/view-list.svg" height="30px" width="30px"></button>
					</a>
					<a> | </a>

					<button onclick=" konfirmasi(<?php echo $Get['id_petugas']; ?>)" style="background: none;"><img src="../img/trash.svg" height="30px" width="30px"></button>
				</td>
			</tr>
	<?php
		}
